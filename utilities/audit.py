"""
Scirpt to audit the state of models retained and evaluate their performance
"""
...
backtesting_data_scaled = scaler.scale_df_with_params(backtesting_data, "saved_models/" + model_id + "/" + model_id + "_coeffs.csv")
