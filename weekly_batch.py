...
train_model(model_type = "model 1").train(epochs = 22, verbose = True)
train_model(model_type = "model 2").train(epochs = 22, verbose = True)
train_model(model_type = "model 3").train(epochs = 22, verbose = True)
