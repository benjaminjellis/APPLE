...
week_no = 17
user_prediction_file_name = "/week" + str(week_no) + "predictions.csv"
...
"""
sic.get_fixtures_and_user_predictions(start_date = start_date, end_date = end_data, output_loc = user_prediction_loc_abs + user_prediction_file_name)
